...
SER1="max9295 $(printf "\\$(printf '%03o' "$((ascii_base_value))")")-${PRT1}"
SER2="max9295 $(printf "\\$(printf '%03o' "$((ascii_base_value + 1))")")-${PRT1}"
SER3="max9295 $(printf "\\$(printf '%03o' "$((ascii_base_value))")")-${PRT2}"
SER4="max9295 $(printf "\\$(printf '%03o' "$((ascii_base_value + 1))")")-${PRT2}"
DES1="max9296 $(printf "\\$(printf '%03o' "$((ascii_base_value + PRT1))")")"
DES2="max9296 $(printf "\\$(printf '%03o' "$((ascii_base_value + PRT2))")")"
